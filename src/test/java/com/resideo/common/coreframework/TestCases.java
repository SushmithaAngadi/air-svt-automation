...
import com.resideo.commons.bddinterface.TestCaseMarkerClass;
import com.resideo.commons.deviceCloudProviders.PCloudyExecutionDesiredCapability;
import com.resideo.commons.devicepool.DevicePoolUtility;
import com.resideo.commons.devicepool.LocalDevicePool;
import com.resideo.commons.devicepool.NoDeviceFoundException;
import com.resideo.commons.devicepool.UnExpectedException;
...
import com.resideo.commons.mobile.PostTestCompleted;
import com.resideo.commons.perfecto.PerfectoConstants;
import com.resideo.commons.perfecto.WindTunnelUtils;
import com.resideo.commons.report.CustomLogger;
import com.resideo.commons.report.FailType;
import com.resideo.commons.report.XRayUtils;
import com.resideo.commons.report.rebot.RebotReportUtils;
import com.resideo.commons.report.rebot.XMLTestNode;
...
public class TestCases implements TestCaseMarkerClass {
	...
	private static int trailNo = 0;

	public static int incrementTrailNo() {
		return ++trailNo;
	}

	public static int getTrailNo() {
		return trailNo;
	}
...
//		testCaseName = testCaseName.append((inputs.getInputValue("index").equals("0")?" - #1": " - #" + (Integer.valueOf(inputs.getInputValue("index"))+1)));
		incrementTrailNo();
		testCaseName = testCaseName.append(" - #"+getTrailNo());
