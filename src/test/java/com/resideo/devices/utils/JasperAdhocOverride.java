//package com.resideo.jasper.utils;
//
...
//import com.resideo.account.information.DeviceInformation;
...
//import com.resideo.lyric.utils.GlobalVariables;
//import com.resideo.screens.AdhocScreen;
//import com.resideo.screens.FlyCatcherPrimaryCard;
//import com.resideo.screens.SchedulingScreen;
//
...
//			}
//			
//			if(fly.IsSystemModeButtonVisible(5))
//				fly.clickOnSystemModeButton();
//			
//			if (expectedMode.equalsIgnoreCase("Heat")) {
//				fly.changeSystemModeToHeatMode();
//			}
//
//			else if (expectedMode.equalsIgnoreCase("Cool")) {
//				fly.changeSystemModeToCoolMode();
//			}
//
//			else if (expectedMode.equalsIgnoreCase("Off")) {
//				fly.changeSystemModeToOffMode();
//			} else if (expectedMode.equalsIgnoreCase("Auto")) {
//				fly.changeSystemModeToAutoMode();
//			}
//			
//			//'If' Code snippet added for ChangeSystemModeSaveOrDclineChanges keyword
//			// Author : Vinayak A H(H12595)
//			if(inputs.isInputAvailable("SAVE_CHANGES"))
//			{
//				//TODO Verify System mode description
//				if(inputs.getInputValue("SAVE_CHANGES").equals("YES"))
//					sch.clickOnSaveButton();
//				else if(inputs.getInputValue("SAVE_CHANGES").equals("NO")) 
//				{
//					if(sch.isCloseButtonVisible(2))
//						sch.clickOnCloseButton();
//					else if(sch.isBackButtonVisible(2))
//						sch.clickOnBackButton();
//					else 
//					{
//						flag = false;
//						Keyword.ReportStep_Fail(testCase, FailType.FRAMEWORK_CONFIGURATION, "Not able to find Cross/ Back Button.");
//					}
//				}					
//				else
//					sch.clickOnSaveButton();
