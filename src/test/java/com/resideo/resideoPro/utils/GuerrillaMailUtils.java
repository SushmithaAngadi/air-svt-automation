...
import com.resideo.commons.coreframework.Email;
...
public class GuerrillaMailUtils {
	 ...
	 */
	public static boolean isEmailFound(TestCaseInputs inputs, TestCases testCase, String subject, String userEmail) {
		boolean flag = true;
		String notificationMailFrom = "";
...
//			notificationMailFrom = "lyric@honeywell.com";
			notificationMailFrom = "honeywellhomessupport@honeywell.com";
		} else if (environment.equalsIgnoreCase("CHIL Stage (Azure)") || environment.equalsIgnoreCase("CHILStage(Azure)")) {
			notificationMailFrom = "honeywellhomessupport@honeywell.com";
		} else if (environment.equalsIgnoreCase("Chil Das(Test)")) {
			notificationMailFrom = "lyric@honeywell.com";
		} else if (environment.equalsIgnoreCase("Chil Das(QA)")) {
			notificationMailFrom = "lyric@honeywell.com";
		} else if (environment.equalsIgnoreCase("Chil Int (Azure)") || environment.equalsIgnoreCase("ChilInt(Azure)")) {
			notificationMailFrom = "honeywellhomessupport@honeywell.com";
		}
		List<NameValuePair> formparams = new ArrayList<NameValuePair>();
		httpPost = new HttpPost(String.format(apiAddr, "set_email_user"));
	...
	public String getLink(TestCaseInputs inputs, TestCases testCase, String subject, String emailAddress,
			String environment) {
		String extractedLink = "";
		List<NameValuePair> formparams = new ArrayList<NameValuePair>();
		httpPost = new HttpPost(String.format(apiAddr, "set_email_user"));
	...
	public static String getLink(TestCaseInputs inputs, TestCases testCase, String subject, String email) throws Exception {
		String extractedLink = "";
		...
		formparams.add(new BasicNameValuePair("sid_token", sidToken));
		formparams.add(new BasicNameValuePair("lang", lang));
		if (isEmailFound(inputs, testCase, subject, emailAddress)) {
			try {
				UrlEncodedFormEntity entity = new UrlEncodedFormEntity(formparams, "UTF-8");
				String mailID = jSonObject.getString("mail_id");
				httpPost.setEntity(entity);
		...
		if (environment.equalsIgnoreCase("Production")) {
//			useractivationLinkstart = extractedLink.indexOf("https://chilpasswordreset.alarmnet.com");
			useractivationLinkstart = extractedLink.indexOf("https://passwordreset.chil.connectedlyric.com");			
			extractedLink = extractedLink.substring(useractivationLinkstart);
			useractivationLinkEnd = extractedLink.indexOf("\"");
		} else if (environment.equalsIgnoreCase("CHIL Stage (Azure)") || environment.equalsIgnoreCase("CHILStage(Azure)")) {
			useractivationLinkstart = extractedLink.indexOf("https://passwordreset.stage.chil.connectedlyric.com");
			extractedLink = extractedLink.substring(useractivationLinkstart);
			useractivationLinkEnd = extractedLink.indexOf("\"");
		} else if (environment.equalsIgnoreCase("Chil Das(QA)")||environment.equalsIgnoreCase("ChilDas(QA)")) {
			useractivationLinkstart = extractedLink.indexOf("https://passwordresetdasqa");
		...
		else if (environment.equalsIgnoreCase("ChilInt(Azure)") || environment.equalsIgnoreCase("Chil Int (Azure)")) {
			useractivationLinkstart = extractedLink.indexOf("https://passwordresetdev.connectedlyric.com");
			extractedLink = extractedLink.substring(useractivationLinkstart);
			useractivationLinkEnd = extractedLink.indexOf("\"");
		}
