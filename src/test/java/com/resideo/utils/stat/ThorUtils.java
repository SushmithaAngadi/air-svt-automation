...
//						.thorSetISU(ThorIsuMsg.newBuilder().setIsu(IsuItem.valueOf(isuType.toUpperCase()))
...
//	}
	...
	public static boolean setThor_Alert(TestCases testCase, String alertType, String alertValue) {
		boolean flag = false;
		try {
			flag = StatCommands.getInstance().cattCommandsStub.setAlertDevices(AlertmessageData.newBuilder()
					.setState(com.resideo.utils.stat.cattgrpccommands.AlertmessageData.ISUDevice.THOR)
	...
	public static boolean verifyThor_Alert(TestCases testCase, String alertType, String alertValue) {
		boolean flag = false;
		try {
