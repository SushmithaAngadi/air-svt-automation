@FUJICOM_14191_FujiX2SRetail_DIY_CWire_No_StartSetupScreen_Conv_Rad_1H1C
Feature: FUJI Devices Registration on First Alert app using BLE flow
  Switches needs to be On : W, G, Y
  
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_StdEff_1H1C
	Scenario: FUJICOM-14192_FUJI DIY registration  from Startup Screen state_Conv_StdEffGas_1H1C
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_HighEffGas_1H1C
	Scenario: FUJICOM-14193_FUJI DIY registration using FA app from Startup Screen state_Conv_HighEff_1H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Oil_1H1C
	Scenario: FUJICOM-14195_FUJI DIY registration using FA app from Startup Screen state_Conv_Oil_1H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_HotWaterFanCoil_1H1C
	Scenario: FUJICOM-14196_FUJI DIY registration using FA app from Startup Screen state_Conv_HotWaterFanCoil_1H1C	
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Electric_1H1C
	Scenario: 	FUJICOM-14197_FUJI DIY registration using FA app from Startup Screen state_Conv_Electric_1H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
#
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Radiant_HotWater_1H1C
	Scenario: FUJICOM-14198_FUJI DIY registration using FA app from Startup Screen state_Radiant_HotWater_1H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Radiant_Steam_1H1C
	Scenario: FUJICOM-14199_FUJI DIY registration using FA app from Startup Screen state_Radiant_Steam_1H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
