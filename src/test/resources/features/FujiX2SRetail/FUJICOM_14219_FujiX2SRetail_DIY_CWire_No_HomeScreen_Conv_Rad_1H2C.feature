@FUJICOM-14219_FujiX2SRetail_DIY_CWire_No_HomeScreen_Conv_Rad_1H2C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : W, G, Y, Y2

	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_StdEff_1H2C
	Scenario: FUJICOM-14225_FUJI DIY registration using FA app from Home Screen state_Conv_StdEffGas_1H2C
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_HighEffGas_1H2C
	Scenario: FUJICOM-14226_FUJI DIY registration using FA app from Home Screen state_Conv_HighEff_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_Oil_1H2C
	Scenario: FUJICOM-14227_FUJI DIY registration using FA app from Home Screen state_Conv_Oil_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_HotWaterFanCoil_1H2C
	Scenario: FUJICOM-14228_FUJI DIY registration using FA app from Home Screen state_Conv_HWFC_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_Electric_1H2C
	Scenario: FUJICOM-14229_FUJI DIY registration using FA app from Home Screen state_Conv_Elec_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Radiant_HotWater_1H2C
	Scenario: FUJICOM-14230_FUJI DIY registration using FA app from Home Screen state_Rad_HW_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
#	
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Radiant_Steam_1H2C
	Scenario: FUJICOM-14231_FUJI DIY registration using FA app from Home Screen state_Rad_Steam_1H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
