@FUJICOM_14221_FujiX2SRetail_DIY_CWire_No_HomeScreen_Conv_Rad_2H2C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : W, G, Y, Y2, W2

	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_StdEff_2H2C
	Scenario: FUJICOM-14239_FUJI DIY registration using FA app from Home Screen state_Conv_Gas_2H2C
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_HighEffGas_2H2C
	Scenario: FUJICOM-14240_FUJI DIY registration using FA app from Home Screen state_Conv_HighEff_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_Oil_2H2C
	Scenario: FUJICOM-14241_FUJI DIY registration using FA app from Home Screen state_Conv_Oil_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_HotWaterFanCoil_2H2C
	Scenario: FUJICOM-14242_FUJI DIY registration using FA app from Home Screen state_Conv_HWFC_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Conv_Gas_Electric_2H2C
	Scenario: FUJICOM-14243_FUJI DIY registration using FA app from Home Screen state_Conv_Elec_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
###	*********************************************************************************
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Radiant_HotWater_2H2C
	Scenario: FUJICOM-14244_FUJI DIY registration using FA app from Home Screen state_Rad_HW_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_Radiant_Steam_2H2C
	Scenario: FUJICOM-14245_FUJI DIY registration using FA app from Home Screen state_Rad_Steam_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
