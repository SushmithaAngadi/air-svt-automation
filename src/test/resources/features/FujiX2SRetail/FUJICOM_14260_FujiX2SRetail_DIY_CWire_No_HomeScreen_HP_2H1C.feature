@FUJICOM_14260_FujiX2SRetail_DIY_CWire_No_HomeScreen_HP_2H1C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : O/B, G, Y, W2, E

	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_HP_WarmAir_ElectricHeat_2H1C
	Scenario: FUJICOM-14272_FUJI DIY registration using FA app from Home Screen state_HP_Elec_WarmAir_2H1C
	...
	@FujiX2SRetail_DIY_CWire_No_FromHomeScreen_HP_CoolAir_ElectricHeat_2H1C
	Scenario: FUJICOM-14273_FUJI DIY registration using FA app from Home Screen state_HP_Elec_CoolAir_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
