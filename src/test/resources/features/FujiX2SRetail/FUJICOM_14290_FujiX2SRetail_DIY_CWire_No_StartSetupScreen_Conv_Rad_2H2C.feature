@FUJICOM_14290_FujiX2SRetail_DIY_CWire_No_StartSetupScreen_Conv_Rad_2H2C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : W, G, Y, Y2, W2

	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_StdEff_2H2C
	Scenario: FUJICOM-14291_FUJI DIY registration  from Startup Screen state_Conv_StdEffGas_2H2C
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_HighEffGas_2H2C
	Scenario: FUJICOM-14292_FUJI DIY registration using FA app from Startup Screen state_Conv_HighEff_2H2C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Oil_2H2C
	Scenario: FUJICOM-14293_FUJI DIY registration using FA app from Startup Screen state_Conv_Oil_2H2C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Gas_HotWaterFanCoil_2H2C
	Scenario: FUJICOM-14294_FUJI DIY registration using FA app from Startup Screen state_Conv_HotWaterFanCoil_2H2C	
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Conv_Electric_2H2C
	Scenario: FUJICOM-14295_FUJI DIY registration using FA app from Startup Screen state_Conv_Electric_2H2C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
#
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Radiant_HotWater_2H2C
	Scenario: FUJICOM-14296_FUJI DIY registration using FA app from Startup Screen state_Radiant_HotWater_2H2C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_No_FromStartUpScreen_Radiant_Steam_2H2C
	Scenario: FUJICOM-14297_FUJI DIY registration using FA app from Startup Screen state_Radiant_Steam_2H2C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
