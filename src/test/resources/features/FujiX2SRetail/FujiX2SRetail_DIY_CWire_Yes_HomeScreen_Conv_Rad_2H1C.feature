@FujiX2SRetail_DIY_CWire_Yes_HomeScreen_Conv_Rad_2H1C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : W, W2 (Y, G are considered for C Wire)

	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Gas_StdEff_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Gas_2H1C
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_HighEffGas_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_HighEff_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Oil_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Oil_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_HotWaterFanCoil_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_HWFC_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Electric_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Elec_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Radiant_HotWater_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Rad_HW_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Radiant_Steam_2H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Rad_Steam_2H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
