@FujiX2SRetail_DIY_CWire_Yes_HomeScreen_Conv_Rad_2H2C
...
#   Switches needs to be On : W, W2, Y2 (Y, G are considered for C Wire)
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Gas_StdEff_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Gas_2H2C
...
#	
#
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_HighEffGas_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_HighEff_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Oil_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Oil_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_HotWaterFanCoil_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_HWFC_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Electric_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Conv_Elec_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Radiant_HotWater_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Rad_HW_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_Conv_Radiant_Steam_2H2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_Rad_Steam_2H2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
