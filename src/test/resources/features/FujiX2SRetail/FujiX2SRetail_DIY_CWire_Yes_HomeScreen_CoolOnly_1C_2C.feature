@FujiX2SRetail_DIY_CWire_Yes_HomeScreen_CoolOnly_1C_2C
...
#   Switches needs to be On : None (Y, G are considered for C Wire) --- Y2 (Y, G are considered for C Wire)
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_CoolOnly_1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_CoolOnly_1C
...
#
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_CoolOnly_2C
	Scenario: FUJI DIY registration using FA app from Home Screen state_CoolOnly_2C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
