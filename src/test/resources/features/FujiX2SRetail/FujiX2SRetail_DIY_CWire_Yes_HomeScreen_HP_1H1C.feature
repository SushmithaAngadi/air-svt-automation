@FujiX2SRetail_DIY_CWire_Yes_HomeScreen_HP_1H1C
...
#   Switches needs to be On : O/B (Y, G are considered for C Wire)
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_HP_WarmAir_ElectricHeat_1H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_HP_Elec_WarmAir_1H1C
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromHomeScreen_HP_CoolAir_ElectricHeat_1H1C
	Scenario: FUJI DIY registration using FA app from Home Screen state_HP_Elec_CoolAir_1H1C
	And user broadcast FUJI device for registration from "HOME" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
