@FujiX2SRetail_DIY_CWire_Yes_StartSetupScreen_Conv_Rad_2H1C
Feature: FUJI Devices Registration on First Alert app using BLE flow
#   Switches needs to be On : W, Y2 (Y, G are considered for C Wire)

	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Conv_Gas_StdEff_2H1C
	Scenario: FUJI DIY registration  from Startup Screen state_Conv_StdEffGas_2H1C
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Conv_Gas_HighEffGas_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Conv_HighEff_2H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Conv_Oil_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Conv_Oil_2H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Conv_Gas_HotWaterFanCoil_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Conv_HotWaterFanCoil_2H1C	
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Conv_Electric_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Conv_Electric_2H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
...
##	*********************************************************************************
#
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Radiant_HotWater_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Radiant_HotWater_2H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
	...
	@FujiX2SRetail_DIY_CWire_Yes_FromStartUpScreen_Radiant_Steam_2H1C
	Scenario: FUJI DIY registration using FA app from Startup Screen state_Radiant_Steam_2H1C
	And user broadcast FUJI device for registration from "START SETUP" screen 
	Given user launches and logs in to the "first alert" app
	Then Add new device to Configure in First Alert App
	Then Setup Device "Location and name" for DIY
