@ReziApp_Jasper_Senior_DIY_Updated_1
...
Scenario: HTA-541 Jasper DIY using bLE on Resideo pro app with cool only one stage configuration
...
Scenario: HTA-542 Jasper DIY using bLE on Resideo pro app with cool only two stage configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
	...
	Then Set Rezi App ISUType "OUTDOOR AIR SENSOR" to ISUValue "INTERNET" 
	Then Set Rezi App ISUType "HEATING SYSTEM" to ISUValue "NONE COOL ONLY" 
	Then Set Rezi App ISUType "COOLING STAGES" to ISUValue "2" 
...
Scenario: HTA-543 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as gas High efficiency 1H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-544 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as gas standard efficiency 1H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-545 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Oil 1H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-546 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-547 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H0C Fan operation tstat controls
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-548 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as HotWaterFan coil 1H0C Fan operation tstat controls
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-549 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as HotWaterFan coil 1H0C Fan operation Equip Controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-550 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas high efficiency 1H1C
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-551 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas standard efficiency 1H1C configuration
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-552 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as oil 1H1C configuration
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-553 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H1C Fan operation Equip controls configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-554 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 1H1C Fan operation Equip controls configuration
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-555 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H1C Fan operation Thermostat controls configuration
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-556 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 1H1C Fan operation Thermostat controls
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-557 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas high efficiency 2H0C configuration
		Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-558 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas standard efficiency 2H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-559 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Oil 2H0C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-560 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H0C Fan operation as Equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-561 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H0C Fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-562 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 2H0C Fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-563 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 2H0C Fan operation as Equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-564 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas high efficiency 2H1C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-565 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas standard efficiency 2H1C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-566 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Oil 2H1C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-567 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H1C Fan operation as Equip Controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-568 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 2H1C Fan operation as Equip Controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-569 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H1C Fan operation as Tstat Controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-570 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 2H1C Fan operation as Tstat Controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
...
Scenario: HTA-571 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas High efficiency 1H2C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-572 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas standard efficiency 1H2C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-573 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Oil 1H2C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-574 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H2C Fan operation as Equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-575 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 1H2C Fan operation as Equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-576 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 1H2C Fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-577 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 1H2C Fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-579 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Gas standard efficiency 2H2C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-580 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Oil 2H2C configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-581 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H2C fan operation as equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-582 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Hot water fan coil 2H2C fan operation as equip controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-583 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as Electric 2H2C fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-584 Jasper DIY using bLE on Resideo pro app with Heating sys as Conventional forced air and fuel as HotWaterFan coil 2H2C fan operation as Tstat controls
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-585 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Air to Air 1H1C reverse valve O OB ON COOL configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "REVERSING VALVE" to ISUValue "REVERSING VALVE O OB ON COOL" 
	Then Set Rezi App ISUType "COMPRESSOR STAGES" to ISUValue "1" 
	Then Set Rezi App ISUType "BACKUP HEAT STAGE" to ISUValue "NONE" 
	Then Set Rezi App ISUType "SYSTEM CHANGEOVER" to ISUValue "AUTOMATIC" 
	Then Set Rezi App ISUType "AUTO CHANGEOVER DIFFERENTIAL" to ISUValue "deg"
	Then Set Rezi App ISUType "COMPRESSOR CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT" 
	Then Set Rezi App ISUType "COMPRESSOR MINIMUM OFF TIME" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN COOL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN HEAT" to ISUValue "DEFAULT"
...
Scenario: HTA-586 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Air to Air 2H2C reverse valve B ON HEAT configuration
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-587 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Geothermal 2H1C reverse valve B ON HEAT with AuxE terminal Together
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "COMPRESSOR STAGES" to ISUValue "1" 
	Then Set Rezi App ISUType "BACKUP HEAT STAGES" to ISUValue "1" 
	Then Set Rezi App ISUType "AUX/E TERMINAL CONTROL" to ISUValue "DRIVE BOTH AUX AND E TOGETHER"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "ELECTRIC"
	Then Set Rezi App ISUType "SYSTEM CHANGEOVER" to ISUValue "AUTOMATIC" 
	Then Set Rezi App ISUType "AUTO CHANGEOVER DIFFERENTIAL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "FINISH WITH HIGH COOL STAGE" to ISUValue "YES"
	...
	Then Set Rezi App ISUType "COMPRESSOR CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT" 
	Then Set Rezi App ISUType "BACKUP HEAT CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "COMPRESSOR MINIMUM OFF TIME" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN COOL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN HEAT" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "ADAPTIVE INTELLIGENT RECOVERY" to ISUValue "YES"
...
Scenario: HTA-588 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Air to Air 2H1C reverse valve B ON HEAT with AuxE term Independent
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "COMPRESSOR STAGES" to ISUValue "1" 
	Then Set Rezi App ISUType "BACKUP HEAT STAGES" to ISUValue "1" 
	Then Set Rezi App ISUType "AUX/E TERMINAL CONTROL" to ISUValue "AUX AND E ARE INDEPENDENT"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "ELECTRIC"
	Then Set Rezi App ISUType "EMERGENCY HEAT" to ISUValue "ELECTRIC"
	Then Set Rezi App ISUType "SYSTEM CHANGEOVER" to ISUValue "AUTOMATIC" 
	Then Set Rezi App ISUType "AUTO CHANGEOVER DIFFERENTIAL" to ISUValue "DEFAULT"
	...
	Then Set Rezi App ISUType "COMPRESSOR CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT" 
	Then Set Rezi App ISUType "BACKUP HEAT CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EMERGENCY HEAT CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "COMPRESSOR MINIMUM OFF TIME" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN COOL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "EXTENDED FAN RUN TIME IN HEAT" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "ADAPTIVE INTELLIGENT RECOVERY" to ISUValue "YES"
...
Scenario: HTA-589 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Geothermal 2H1C reverse valve B ON HEAT with AuxE term Independent and backupHeat as electric
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "FINISH WITH HIGH HEAT STAGE" to ISUValue "YES"
	Then Set Rezi App ISUType "BACKUP HEAT DROOP" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "BACKUP HEAT DROOP" to ISUValue "0deg"
	Then Set Rezi App ISUType "COMPRESSOR LOCKOUT" to ISUValue "OFF" 
	Then Set Rezi App ISUType "OUTDOOR HEAT LOCKOUT" to ISUValue "OFF" 
	Then Set Rezi App ISUType "COMPRESSOR CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT" 
	Then Set Rezi App ISUType "BACKUP HEAT CYCLES PER HOUR-STAGE 1" to ISUValue "DEFAULT"
...
Scenario: HTA-590 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Air to Air 2H1C reverse valve B ON HEAT with AuxE terminal Together and backup heat as GasStandard
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "AUX/E TERMINAL CONTROL" to ISUValue "DRIVE BOTH AUX AND E TOGETHER"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "GAS STANDARD"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "EXTERNAL FOSSIL FUEL KIT"
	Then Set Rezi App ISUType "SYSTEM CHANGEOVER" to ISUValue "AUTOMATIC" 
	Then Set Rezi App ISUType "AUTO CHANGEOVER DIFFERENTIAL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "FINISH WITH HIGH COOL STAGE" to ISUValue "YES"
	Then Set Rezi App ISUType "FINISH WITH HIGH HEAT STAGE" to ISUValue "YES"
...
Scenario: HTA-591 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Geothermal 2H1C reverse valve B ON HEAT with AuxE terminal Together and backupHeat as GasStandard
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-592 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as AirToAir 2H1C reverse valve B ON HEAT with AuxE term Indpent and backupHeat as GasStandard EmHeat as GasOil
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-593 Jasper DIY using bLE on Resideo pro app with Heating sys as HeatPump and fuel as Geothermal 2H1C reverse valve B ON HEAT with AuxE term Indept and backupHeat as GasStandard EmHeat as GasOil
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
...
Scenario: HTA-594 Jasper DIY using bLE on Resideo pro app with Heating sys as Heat pump and fuel as Air to Air 2H1C reverse valve B ON HEAT with AuxE terminal Together and backupHeat as GasStandard
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup
	...
	Then Set Rezi App ISUType "AUX/E TERMINAL CONTROL" to ISUValue "DRIVE BOTH AUX AND E TOGETHER"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "GAS STANDARD"
	Then Set Rezi App ISUType "BACKUP HEAT" to ISUValue "THERMOSTAT"
	Then Set Rezi App ISUType "SYSTEM CHANGEOVER" to ISUValue "AUTOMATIC" 
	Then Set Rezi App ISUType "AUTO CHANGEOVER DIFFERENTIAL" to ISUValue "DEFAULT"
	Then Set Rezi App ISUType "FINISH WITH HIGH COOL STAGE" to ISUValue "YES"
	Then Set Rezi App ISUType "FINISH WITH HIGH HEAT STAGE" to ISUValue "YES"
...
Scenario: HTA-599 Jasper device registration using bLE mode on Resideo pro app with Heating system as Heat pump and fuel as Air to Air
	Given user launches and logs in to the Rezi APP 
	And User BroadCast the device for Registration from "Start setup" Screen 
	Then Add new device for Configuration in Rezi App 
	And Perform Resideo Pro initial installtion setup 
