...
@Cisco_EA6300V2_Wifi_Router_Change_SSID_Name_5ghz @Cisco_EA6300V2_5GHZ
Scenario: Cisco_EA6300V2_5GHZ verify connectivity with SSID NAME 5Ghz

	Given start wifi intigeration with switch and turn on "cisco" router and the model is "EA6300V2"
	...
	Then user edit router settings as "frequency to 5GHz;SSID name is Cisco_5" in "advance wireless settings" router screen 
 	Then configure the thermostat "valid" wifi ssid name "Cisco_5" ,password "Home@123." and security type as "WPA2 Personal"
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
...
@Cisco_EA6300V2_Wifi_Router_Change_Password_2_4Ghz @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify connectivity with different password for 2.4Ghz
  ...
  Given start wifi intigeration with switch and turn on "cisco" router and the model is "EA6300V2" 
	...
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	When user edit router settings as "frequency to 2.4GHz;SSID name is Cisco;is SSID to No;mode to Auto;channel to 1;security to WPA2 Personal;password is home234" in "advance wireless settings" router screen 
 	Then configure the thermostat "valid" wifi ssid name "Cisco_24" ,password "home234" and security type as "WPA2 Personal"
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	When user edit router settings as "frequency to 2.4GHz;SSID name is Cisco;is SSID to No;mode to Auto;channel to 1;security to WPA2 Personal;password is Password@1" in "advance wireless settings" router screen 
 	Then configure the thermostat "valid" wifi ssid name "Cisco_24" ,password "Password@1" and security type as "WPA2 Personal"
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	
#@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WPA2_Enterprise_2_4Ghz
...
#@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WEP_2_4Ghz
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WPA2_PERSONAL_2_4Ghz @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify wifi standard b_g_n with wifi_SecurtyType_WPA2_PERSONAL for 2_4 Ghz 
	...
	@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WPA2_PERSONAL_5Ghz @Cisco_EA6300V2_5GHZ
Scenario: Cisco_EA6300V2_5GHZ verify wifi standard b_g_n with wifi_SecurtyType_WPA2_PERSONAL for 5 Ghz
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_G_ONLY @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify wifi standard b_g_n with channels for 2_4 Ghz band 
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_N_ONLY @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify wifi standard b_g_n with channels for 2_4 Ghz band 
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_channel_5Ghz @Cisco_EA6300V2_5GHZ
Scenario: Cisco_EA6300V2_5GHZ verify wifi standard b_g_n with channels for 5 Ghz band 
...
#@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WPA2_WPA_Mixed_Enterprise_5Ghz
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_with_Bandwidth_5Ghz @Cisco_EA6300V2_5GHZ
Scenario: Cisco_EA6300V2_5GHZ verify connectivity with standard b_g_n with Bandwidth for 5Ghz band 
...
@Cisco_EA6300V2_Wifi_Router_standard_bgn_with_Bandwidth_2_4Ghz @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify connectivity with standard b_g_n with Bandwidth for 2_4 Ghz band 
...
#@Cisco_EA6300V2_Wifi_Router_standard_bgn_wifi_SecurtyType_WPA2_Enterprise_5Ghz
...
@Cisco_EA6300V2_Wifi_Router_Change_DHCP_disable_2_4Ghz @Cisco_EA6300V2_24GHZ
Scenario: Cisco_EA6300V2_24GHZ verify connectivity with Wifi_Router_DHCP_Disable_2_4Ghz 
 ...
 Given start wifi intigeration with switch and turn on "cisco" router and the model is "EA6300V2" 
	...
	@Cisco_EA6300V2_Wifi_Router_Change_DHCP_disable_5Ghz @Cisco_EA6300V2_5GHZ
Scenario: Cisco_EA6300V2_5GHZ verify connectivity with Wifi_Router_DHCP_Disable_5Ghz 
...
@Cisco_EA6300V2_Wifi_Router_Change_DHCP_Client_Lease_Time
Scenario: Cisco_EA6300V2_Wifi_Router_Change_DHCP_Client_Lease_Time
...
@Cisco_EA6300V2_Wifi_Router_Change_DHCP_IP_Address
Scenario: Cisco_EA6300V2_Wifi_Router_Change_DHCP_IP_Address_MaxUsers
...
@Cisco_EA6300V2_Wifi_Router_Change_DHCP_MaxUser
Scenario: Cisco_EA6300V2_Wifi_Router_Change_DHCP_MaxUser
...
@Cisco_EA6300V2_Wifi_Router_Change_DHCP_DNS_IP
Scenario: Cisco_EA6300V2_Wifi_Router_Change_DNS_IP
