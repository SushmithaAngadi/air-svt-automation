...
@NETGEAR_R6400V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_demo1 
Scenario: verify wifi standard b_g_n with channels for 2_4 Ghz band demo1_netgear 

	Given start wifi intigeration with switch and turn "on netgear" router and the model is "R6400V2" 
	...
	Then configure the thermostat "valid" wifi ssid name "NETGEAR50" ,password "Home@123." and security type as "WPA2 AES"
...
@NETGEAR_R6400V2_Wifi_Router_Change_SSID_Password_2_4Ghz_demo 
Scenario: verify connectivity with Wifi_Router_Security_type_WPA2_2_4Ghz 
  ...
  Given Launch browser and login to the router 
	...
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	Then user edit router settings as "frequency to 2.4GHz;SSID name is NETGEAR" in "advance wireless settings" router screen 
	Then configure the thermostat "valid" wifi ssid name "NETGEAR" ,password "Home@123." and security type as "WPA2 AES"
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
...
@NETGEAR_R6400V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_N_ONLY
Scenario: verify wifi standard b_g_n with channels for 2_4 Ghz band N
...
@NETGEAR_R6400V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_BGN
Scenario: verify wifi standard b_g_n with channels for 2_4 Ghz band B G N
...
@NETGEAR_R6400V2_Wifi_Router_standard_bgn_wifi_channel_2_4Ghz_G_ONLY
Scenario: verify wifi standard b_g_n with channels for 2_4 Ghz band G
...
#	
#@NETGEAR_R6400V2_Wifi_Router_Security_type_WEP_NONE_2_4Ghz 
...
@NETGEAR_R6400V2_Wifi_Router_Security_type_WPA_WPA2_2_4Ghz 
Scenario: verify connectivity with Wifi_Router_Security_type_WPA_2_4Ghz 
	...
	Then configure the thermostat "valid" wifi ssid name "NETGEAR50" ,password "Home@123." and security type as "WPA_WPA2 MIXED"
	Then verify the connection status as "connected" from thermostat IP 
	And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	Then user edit router settings as "frequency to 2.4GHz;mode to N" in "advance wireless settings" router screen 
	Then user edit router settings as "frequency to 2.4GHz;security to WPA_WPA2 MIXED;password is Home@123.;" in "advance wireless settings" router screen  
...
#@NETGEAR_R6400V2_Wifi_Router_Security_type_WEP_NONE_2_4Ghz_Hidden_SSID 
...
@NETGEAR_R6400V2__Wifi_Router_Change_DHCP_disable_2_4Ghz 
