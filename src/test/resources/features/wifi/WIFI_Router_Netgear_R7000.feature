...
@Netgear_R7000_Wifi_Router_verify_channels_24Ghz_G_ONLY @Netgear_R7000_24Ghz
Scenario: Netgear_R7000_Wifi_Router_verify_channels_2_DOT_4Ghz_G_ONLY
...
@Netgear_R7000_Wifi_Router_verify_channels_24Ghz_N_ONLY  @Netgear_R7000_24Ghz
Scenario: Netgear_R7000_Wifi_Router_verify_channels_2_DOT_4Ghz_N_ONLY

	#Given start wifi intigeration with switch and turn on "netgear" router and the model is "R7000"
	Given Launch browser and login to the router 
	When user edit router settings as "frequency to 2.4GHz;SSID name is Netgear;is SSID to No;mode to N;channel to Auto;security to WPA2_PSK_AES;password is Home@123." in "wireless settings" router screen 
	Then configure the thermostat "valid" wifi ssid name "Netgear" ,password "Home@123." and security type as "WPA2_PSK_AES"
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
...
@Netgear_R7000_Wifi_Router_verify_channels_24Ghz_BGN_ONLY  @Netgear_R7000_24Ghz
Scenario: Netgear_R7000_Wifi_Router_verify_channels_2_DOT_4Ghz_BGN_ONLY

	#Given start wifi intigeration with switch and turn on "netgear" router and the model is "R7000"
	Given Launch browser and login to the router 
	When user edit router settings as "frequency to 2.4GHz;SSID name is Netgear;is SSID to No;mode to B_G_N;channel to Auto;security to WPA2_PSK_AES;password is Home@123." in "wireless settings" router screen 
	Then configure the thermostat "valid" wifi ssid name "Netgear" ,password "Home@123." and security type as "WPA2_PSK_AES"
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
...
@Netgear_R7000_Wifi_Router_Security_type_NONE_24Ghz  @Netgear_R7000_24Ghz
...
#	  Then configure the thermostat "valid" wifi ssid name "Netgear" ,password "" and security type as ""
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	...
	@Netgear_R7000_Wifi_Router_Security_type_TKIP_AES_24Ghz  @Netgear_R7000_24Ghz
...
Scenario: Netgear_R7000_Wifi_Router_Security_type_AES_24Ghz 
	...
	#Given start wifi intigeration with switch and turn on "netgear" router and the model is "R7000"
	Given Launch browser and login to the router 
	When user edit router settings as "frequency to 2.4GHz;SSID name is Netgear;is SSID to No;mode to G;channel to Auto;security to WPA_AES;password is Home@123." in "wireless settings" router screen 
	  Then configure the thermostat "valid" wifi ssid name "Netgear" ,password "Home@123." and security type as "WPA_AES"
	  Then verify the connection status as "connected" from thermostat IP
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	Then user edit router settings as "frequency to 2.4GHz;channel to 9" in "wireless settings" router screen 
	 Then verify the connection status as "connected" from thermostat IP
...
Scenario: Netgear_R7000_Wifi_Router_Security_type_Enterprise_5Ghz 
	...
	When user edit router settings as "frequency to 5GHz;SSID name is Netgear;is SSID to YES;mode to Up to 1300 Mbps for 5GHz;channel to 44;security to Enterprise;WPA Encryption is AES;Radius IP is 1.1.1.1;Radius port is 1813;password is Home@123." in "wireless settings" router screen 
	  Then configure the thermostat "valid" wifi ssid name "Netgear" ,password "Home@123." and security type as ""
	Then user edit router settings as "frequency to 5GHz;channel to 36" in "wireless settings" router screen 
	  Then verify the connection status as "connected" from thermostat IP
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
	Then user edit router settings as "frequency to 5GHz;channel to 44" in "wireless settings" router screen 
...
@Netgear_R7000_Wifi_Router_Change_DHCP  @Netgear_R7000_24Ghz
