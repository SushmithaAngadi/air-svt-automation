@General_TPLINK_AX1800_router_Settings_with_NA_Thermostats_with_AAT
Feature: Jasper TPLINK Router settings for wifi testing

  @TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_SSID_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_SSID_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    ...
    @TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_SSID_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_SSID_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
 ...
 @TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_Password_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_Password_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
   	When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;Version to WPA_PSK_WPA2_PSK;ENCRYPTION to AES;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
    ...
    @TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_Password_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_Password_24Ghz
  	Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  	Then user edit router settings as "frequency to 2.4GHz;SSID name is tplink24;Is SSID to NO;mode to B_G_N_AX_MIXED;security to WPA2_WPA3_PERSONAL ;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "tplink24" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
    ...
    @TPLINK_AX1800_Wifi_Router_wifi_SecurityType_WPA_WPA2_PERSONAL_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_SecurityType_WPA_WPA2_PERSONAL_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
   	When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;Version to WPA_PSK_WPA2_PSK;ENCRYPTION to AES;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
    ...
    Then verify the connection status as "connected" from thermostat IP
     ...
     @TPLINK_AX1800_Wifi_Router_wifi_SecurityType_WPA2_WPA3_PERSONAL_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_SecurityType_WPA2_WPA3_PERSONAL_24Ghz
  	Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  	Then user edit router settings as "frequency to 2.4GHz;SSID name is tplink24;Is SSID to NO;mode to B_G_N_AX_MIXED;security to WPA2_WPA3_PERSONAL ;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "tplink24" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
    ...
    @TPLINK_AX1800_NegativeScenario_Wifi_Router_mode_AX_Only_24Ghz @TPLINK_AX1800_24GHZ
    Scenario: TPLINK_AX1800_NegativeScenario_Wifi_Router_mode_AX_Only_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    Then configure the thermostat "invalid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
     ...
     @TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_B_G_N_MIXED_channels_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_B_G_N_MIXED_channels_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    @TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_BGN_AX_MIXED_channels_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_BGN_AX_MIXED_channels_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  ...
  @TPLINK_AX1800_Wifi_Router_standard_bgn_with_Bandwidth_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_with_Bandwidth_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;ENCRYPTION to AES;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
  ...
  #@TPLINK_AX1800_Wifi_Router_Security_type_NONE_24Ghz @TPLINK_AX1800_24GHZ
  #Scenario: TPLINK_AX1800_Wifi_Router_Security_type_NONE_24Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
    #When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;ENCRYPTION to AES;password is Home@123."" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 2.4GHz;mode to AX ONLY;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "" and security type as "None"
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 2.4GHz;mode to B_G_N_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "" and security type as "None"
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 2.4GHz;mode to B_G_N_AX_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "" and security type as "None"
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud

  #@TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_ENTERPRISE_24Ghz @TPLINK_AX1800_24GHZ
  #Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_ENTERPRISE_24Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
  ...
  #@TPLINK_AX1800_Wifi_Router_Security_type_NONE_24Ghz_Hidden_SSID @TPLINK_AX1800_24GHZ
  #Scenario: TPLINK_AX1800_Wifi_Router_Security_type_NONE_24Ghz_Hidden_SSID
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
    ...
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to AX ONLY;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "" and security type as "None"
    #Then verify the connection status as "connected" from thermostat IP
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 2.4GHz;mode to B_G_N_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
    ...
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
     ...
     @TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL_Hidden_SSID_24GHZ @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL_Hidden_SSID_24GHZ
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  ...
  @TPLINK_AX1800_Wifi_Router_Security_type_WPA3_WPA2_24Ghz_Hidden_SSID @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA3_WPA2_24Ghz_Hidden_SSID
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  ...
  @TPLINK_AX1800_Wifi_Router_Change_DHCP_lease_time_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with Change_DHCP_lease_time_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
  ...
  @TPLINK_AX1800_Wifi_Router_Change_DNS_IP1_2_valid_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with Change_DNS_IP1_2_valid_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
  ...
  @TPLINK_AX1800_Wifi_Router_Change_DNS_IP1_2_invalid_24Ghz @TPLINK_AX1800_24GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with Change_DNS_IP1_2_invalid_24Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 2.4GHz;SSID name is TPLINK;Is SSID to NO;mode to B_G_N_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
    ...
    Then verify the connection status as "connected" from thermostat IP 
		...
		@TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_SSID_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_SSID_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    @TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_SSID_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_SSID_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
 ...
 @TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_Password_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA_WPA2_PERSONAL_Password_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    @TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_Password_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_wifi_WPA2_WPA3_PERSONAL_Password_5Ghz
  	Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  	Then user edit router settings as "frequency to 5GHz;SSID name is tplink5;Is SSID to NO;mode to A_N_AC_AX_MIXED;security to WPA2_WPA3_PERSONAL ;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "tplink5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
  ...
  #@TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_AX_Only_channel_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_AX_Only_channel_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud 
    ...
    @TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_A_N_AC_MIXED_MIXED_channel_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_A_N_AC_MIXED_MIXED_channel_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    @TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_A_N_AC_AX_MIXED_channel_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_standard_bgn_wifi_A_N_AC_AX_MIXED_channel_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
  ...
  @TPLINK_AX1800_Wifi_Router_standard_bgn_with_Bandwidth_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with standard b_g_n with BANDWIDTH for 5 Ghz band3
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
  ...
  @TPLINK_AX1800_Wifi_Router_Security_type_NONE_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with Security_type_NONE_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;password is Home@123."" in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
		Then verify the connection status as "connected" from thermostat IP 
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud 
    #Then user edit router settings as "frequency to 5GHz;mode to AX ONLY;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "" and security type as "None"
#		Then verify the connection status as "connected" from thermostat IP 
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud 
    Then user edit router settings as "frequency to 5GHz;mode to A_N_AC_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "" and security type as "None"
		Then verify the connection status as "connected" from thermostat IP 
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud 
    Then user edit router settings as "frequency to 5GHz;mode to A_N_AC_AX_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "" and security type as "None"
		Then verify the connection status as "connected" from thermostat IP 
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud 
		
		
		@TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL @TPLINK_AX1800_5GHZ
		 Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA_WPA2_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud  
    ...
    @TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_PERSONAL @TPLINK_AX1800_5GHZ
		 Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_PERSONAL
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    Then user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;security to WPA2_WPA3_PERSONAL ;password is Home@123." in "advance wireless settings" router screen
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
  ...
  @TPLINK_AX1800_Wifi_Router_Security_type_NONE_5Ghz_Hidden_SSID @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800 - verify connectivity with type_NONE_5Ghz_Hidden_SSID
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
		Then verify the connection status as "connected" from thermostat IP 
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    #Then user edit router settings as "frequency to 5GHz;is SSID to NO;mode to AX ONLY;security to None for AX1800 model" in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "" and security type as "None"
#		Then verify the connection status as "connected" from thermostat IP 
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    Then user edit router settings as "frequency to 5GHz;mode to A_N_AC_MIXED;security to None for AX1800 model" in "advance wireless settings" router screen
  ...
  @TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL_Hidden_SSID_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA_WPA2_PERSONAL_Hidden_SSID_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
    ...
    Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA_WPA2_PERSONAL_AES"
		...
		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
		 ...
		 @TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_PERSONAL_Hidden_SSID_5Ghz @TPLINK_AX1800_5GHZ
  Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_PERSONAL_Hidden_SSID_5Ghz
    Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    Given Launch browser and login to the router
...
#		@TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_ENTERPRISE_Hidden_SSID_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800_Wifi_Router_Security_type_WPA2_WPA3_ENTERPRISE_Hidden_SSID_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
  ...
  #@TPLINK_AX1800_Wifi_Router_Change_DHCP_disable_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800 - verify connectivity with Change_DHCP_disable_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    ...
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
#
  #@TPLINK_AX1800_Wifi_Router_Change_DHCP_lease_time_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800 - verify connectivity with Change_DHCP_lease_time_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
    #When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
...
#
  ...
  #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
  #
  #@TPLINK_AX1800_Wifi_Router_Change_DNS_IP1_2_valid_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800 - verify connectivity with Change_DNS_IP1_2_valid_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
    #When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
...
#		And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
    ...
    #And user change the "heat" setpoint from cloud using "chil" ,thermostat "should" sync with cloud
#
  #@TPLINK_AX1800_Wifi_Router_Change_DNS_IP1_2_invalid_5Ghz @TPLINK_AX1800_5GHZ
  #Scenario: TPLINK_AX1800 - verify connectivity with Change_DNS_IP1_2_invalid_5Ghz
    #Given start wifi intigeration with switch and turn on "tplink" router and the model is "AX1800"
    #Given Launch browser and login to the router
    #When user edit router settings as "frequency to 5GHz;SSID name is TPLINK5;is SSID to NO;mode to A_N_AC_AX_MIXED;channel to Auto;security to WPA2_WPA3_PERSONAL;password is Home@123." in "advance wireless settings" router screen
    #Then configure the thermostat "valid" wifi ssid name "TPLINK5" ,password "Home@123." and security type as "WPA2_WPA3_PERSONAL"
